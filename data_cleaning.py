...
#
# Main program for cleaning up the Crash Data
#
# Notes:
#   - have to specify the files in global_vars.py
#
# Warning:
#   - This program only cleans the datas with the specified month and
#     this can take up to 25 minutes.
#  
# @author: Steven Guan
#
